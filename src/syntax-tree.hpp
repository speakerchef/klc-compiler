...
struct SyntaxNode {
public:
  std::variant<NodeScope, NodeExpr, NodeIdentifier, NodeVarDeclaration,
               NodeIntLiteral, NodeStmtExit, NodeStmtIf, NodeStmtElse,
               NodeStmtElif, NodeStmtWhile, NodeFunc, NodeCall>
      m_node;
